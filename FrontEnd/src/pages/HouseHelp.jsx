...
const houseHelps = [
  { name: "Sita Devi", rating: 4.9, reviews: 180, charges: "₹200/hr", available: true },
  { name: "Gita Sharma", rating: 4.4, reviews: 95, charges: "₹180/hr", available: true },
  { name: "Radha Singh", rating: 4.7, reviews: 150, charges: "₹220/hr", available: false },
  { name: "Meena Joshi", rating: 4.2, reviews: 80, charges: "₹170/hr", available: true },
];

// Icons representing house help
const houseHelpIcons = ["🧹", "🧺", "🧽", "🍳"];
    ...
    <Box sx={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <Box
        sx={{
          width: "100%",
          height: 250,
          backgroundImage: "url('https://images.unsplash.com/photo-1592582920831-02f47807f0b1?auto=format&fit=crop&w=1350&q=80')",
          ...
          {bookingConfirmation ? (
            ...
            <>
              <Typography variant="h4" sx={{ mb: 4, textAlign: "center", fontWeight: "bold" }}>
                Available House Helps
              </Typography>

              <Grid container spacing={4}>
                {houseHelps.map((h, idx) => (
                  <Grid item xs={12} sm={6} key={h.name}>
                    <Paper sx={{ p: 3, display: "flex", alignItems: "center", justifyContent: "space-between" }} elevation={4}>
                      ...
                      <Box sx={{ flex: 1 }}>
                        <Typography variant="h6" fontWeight="bold">{h.name}</Typography>
                        <Typography>⭐ {h.rating} ({h.reviews} reviews)</Typography>
                        <Typography>💰 {h.charges}</Typography>
                        <Typography color={h.available ? "green" : "red"} fontWeight="bold">
                          {h.available ? "Available Now" : "Currently Unavailable"}
                        </Typography>
                      </Box>
                      <Button
                        variant="contained"
